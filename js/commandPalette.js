...
const TOOL_KEYWORDS = {
  ...
  triads: 'triad patterns closed voicings inversions major minor diminished augmented sus soloing string set sweep picking arpeggio',
  ...
  intervalorbit: 'interval map orbit guitar fretboard shapes root anchor locate name play drop tuning boundary',
