...
metadata:
  author: "mini-spec"
  source: ".cursor/commands/minispec.registry.md"
---

This skill runs the MiniSpec command. You MUST read the command file now and follow it exactly.

Command file: `.cursor/commands/minispec.registry.md`
